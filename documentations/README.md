...
### ניהול עובדים/ות
- ✅ הוספה, עריכה ומחיקה של עובדים/ות
- ✅ ייבוא עובדים/ות מקובץ Excel/ODS
- ✅ ייצוא רשימת עובדים/ות ל-Excel
- ✅ ניהול פרטי עובדים/ות מלאים (כתובת, טלפון, מסלול, שעת איסוף)
- ✅ מערכת הרשאות (עובד/ת, מנהל/ת, מנהל/ת מערכת)
...
### סידור הסעות
- ✅ הקצאת עובדים/ות לנהגים/ות ומסלולים
- ✅ ממשק גרירה ושחרור (Drag & Drop)
- ✅ סימון עובדים/ות שלא יגיעו היום
- ✅ שליחת סידור לנהגים/ות
...
### התראות ועדכונים
- ✅ פרסום התראות לעובדים/ות ונהגים/ות
- ✅ מחיקה אוטומטית של התראות ישנות (אחרי 4 ימים)
- ✅ תצוגה בדשבורד

### אימות והרשאות
- ✅ התחברות עם שם משתמש/ת או קוד עובדת
- ✅ רישום עובדים/ות חדשים/ות
...
1. פתחו את `transport-system.html` בדפדפן
2. במסך ההתחברות, הזינו
   - **שם משתמש/ת** או **קוד עובד/ת** (למשל: "בן אליהו")
   - **סיסמה**
3. לחצו על **"התחברות"**

### יצירת עובד/ת חדש/ה

1. לחצו על **"הרשמה"** במסך ההתחברות
2. מלאו את כל השדות הנדרשים
3. לחצו על **"הרשמה"**

### ייבוא עובדים מ-Excel

1. עברו ל**"רשימת עובדים"**
2. לחצו על **"ייבוא עובדים"**
3. בחרו קובץ Excel/ODS
4. המערכת תזהה אוטומטית את הפורמט ותייבא את העובדים/ות

> 💡 **טיפ**: לחצו על כפתור **"?"** ליד כפתור הייבוא כדי לראות את הפורמט המדויק הנדרש

### יצירת מסלול חדש

1. עברו ל**"ניהול מסלולים"**
2. לחצו על **"מסלול חדש"**
3. הזינו שם למסלול
4. לחצו על המפה או הזינו כתובת כדי להוסיף נקודות
5. לחצו על **"שמור מסלול"**
...
1. **ייצוא עובדים**: עברו ל"רשימת עובדים" → לחצו על "ייצוא עובדים"
2. **שמירת קובץ HTML**: שמרו עותק של `transport-system.html`
3. **גיבוי localStorage**: השתמשו בתוסף דפדפן לגיבוי localStorage

### שחזור נתונים
1. ייבאו את קובץ ה-Excel עם העובדים/ות
2. או שחזרו את localStorage מהגיבוי
